            ...
            <nav class="navbar white navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="lista_aluno.php" class="dropdown-item ps-5 <?= isActive('lista_aluno.php'); ?>">
                                <i class="fa fa-book-open me-2   "></i> Listar
                            </a>
                            <a href="../forms/form_aluno.php" class="dropdown-item ps-5 <?= isActive('form_aluno.php'); ?> "><i
                                    class="fa fa-user-plus me-2 "></i>Registar </a>
                            <a href="editar_aluno.php"
                                class="dropdown-item ps-5 <?= isActive('editar_aluno.php'); ?> "><i
                                    class="fa fa-pen me-2 "></i> Editar</a>
                        </div>
                    </div>
