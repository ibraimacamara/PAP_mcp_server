        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar white navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="form_encarregado.php" class="nav-item nav-link active"><i
                    ...
                    <a href="form_professor.php" class="nav-item nav-link"><i
                        ...
                        <div class="col-12 mb-4">
                            <div class="bg-white shadow rounded h-100 p-4">
                                ...
                                <form action="salvar_encarregado.php" method="POST">
                                    ...
                                    <button type="submit"
                                        class="btn t btn-primary d-block mx-auto w-50">Registar</button>
