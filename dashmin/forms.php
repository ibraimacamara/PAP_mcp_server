...
// // não mostrar erro para utilizador
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar white navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="form_aluno.php" class="nav-item nav-link "><i class="fa fa-user-plus  me-2"></i>Aluno</a>
                    <a href="form_encarregado.php" class="nav-item nav-link"><i class="fa fa-user-tie me-2"></i>Encarregado</a>
                    <a href="forms.php" class="nav-item nav-link active"><i class="fa fa-book-open me-2"></i>Curso Turma</a>
