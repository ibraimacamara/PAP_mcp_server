            ...
            <nav class="navbar white navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="<?= htmlspecialchars($fotoPath) ?>" alt="Foto do usuário"
                ...
                <div class="navbar-nav w-100">
                    <a href="index.php" class="nav-item nav-link <?= isActive('home.php'); ?>"><i
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link " data-bs-toggle="dropdown"><i
                                class="fa fa-user-tie  me-2"></i>Funcionário</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="form_funcionario.php"
                                class="dropdown-item ps-5  <?= isActive('form_funcoinario.php') ? 'active bg-light text-dark shadow' : ''; ?>"><i
                                    class="fa fa-user-plus me-2 text-primary"></i>Registar </a>
                            <a href="lista_funcionario.php"
                                class="dropdown-item ps-5 <?= isActive('lista_funcionario.php') ? 'active bg-light text-dark shadow' : ''; ?>">
                                <i class="fa fa-book-open me-2   text-primary"></i> Listar
                            </a>
        ...
        <div class="content">
            ...
            <script>
                ...
                async function cwSend() {
                    ...
                    if (!text) return;
                    cwAppend(text, 'user');
                    cwInput.value = ''; cwInput.style.height = 'auto';
