                ...
                <div class="navbar-nav w-100">
                    ...
                    <!-- <div class="nav-item dropdown">
                        <a href="#" class="nav-link " data-bs-toggle="dropdown"><i
                                class="fa fa-laptop me-2"></i>Consulta</a>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="img/user.jpg" alt=""
                                style="width: 40px; height: 40px;">
                            <span class="d-none d-lg-inline-flex">Ibraima Camará</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
...
#chatWidget {
    ...
    width: 360px; height: 500px; z-index: 9999;
...
#chatWidget .cw-input-row textarea {
    ...
    padding: 6px 10px; font-size: 14px; resize: none;
...
#chatWidget .cw-input-row button:disabled { background: #aaa; }
.cw-typing span {
...
<div id="chatWidget">
    <div class="cw-header">
        <span><i class="fa fa-robot me-2"></i>Assistente IBRA</span>
