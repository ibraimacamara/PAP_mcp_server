...
.aluno-foto { width: 50%; height: 100%; }
.aluno-foto img { width: 100%; height: 100%; object-fit: cover; }
.aluno-info { width: 50%; padding: 20px; overflow-y: auto; }
.aluno-info h4 { margin-bottom: 15px; }
.aluno-info p { margin-bottom: 10px; }
@media (max-width: 768px) {
    .aluno-card { flex-direction: column; height: auto; }
    .aluno-foto, .aluno-info { width: 100%; height: auto; }
    .aluno-foto img { height: 250px; }
}
</style>
    ...
    <div class="aluno-card">
        ...
        <div class="aluno-info">
            ...
            <div class="d-flex gap-2 mt-3">
                <a href="lista_aluno.php" class="btn btn-secondary btn-sm">Voltar</a>
