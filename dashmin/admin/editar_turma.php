                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="statu" class="form-select">
                                <option value="ativo"   <?= ($turma['statu'] ?? '') == 'ativo'   ? 'selected' : '' ?>>Ativo</option>
                                <option value="inativo" <?= ($turma['statu'] ?? '') == 'inativo' ? 'selected' : '' ?>>Inativo</option>
                            </select>
                        </div>
                    </div>

                    <div class="d-flex gap-2 justify-content-center">
                        <a href="lista_turma.php" class="btn btn-secondary w-25">Cancelar</a>
