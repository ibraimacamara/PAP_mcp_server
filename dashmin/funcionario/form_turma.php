...
<div class="container-fluid pt-4 px-4">
    <div class="row g-4 justify-content-center">
        ...
        <!-- ALERTA_turma_inserir (linha inteira) -->
        <div class="col-12">
            <?php if (!empty($_SESSION['alerta_turma_inserir'])): ?>
                <div id="alerta_turma_inserir"
                    class="alert alert-<?= htmlspecialchars($_SESSION['alerta_turma_inserir']['tipo']) ?> alert-dismissible fade show"
                    role="alert">
                    <?= htmlspecialchars($_SESSION['alerta_turma_inserir']['msg'], ENT_QUOTES, 'UTF-8') ?>
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                </div>

                <script>
                    setTimeout(() => document.getElementById('alerta_turma_inserir')?.remove(), 3000);
                </script>

                <?php unset($_SESSION['alerta_turma_inserir']); ?>
            <?php endif; ?>
        </div>
        ...
        <div class="col-lg-8 col-12">
            <div class="bg-white shadow rounded h-100 p-4">
                <h5 class="mb-4">Inserir Turma</h5>
