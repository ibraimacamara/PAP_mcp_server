     ...
     <div class="sidebar pe-4 pb-3">
            <nav class="navbar white navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="home.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Painel</a>
                    ...
                    <a href="form_aluno.php" class="nav-item nav-link active"><i class="fa fa-user-plus  me-2"></i>Aluno</a>
                    <a href="form_encarregado.php" class="nav-item nav-link"><i class="fa fa-user-tie me-2"></i>Encarregado</a>
                    <a href="forms.php" class="nav-item nav-link"><i class="fa fa-book-open me-2"></i>Curso Turma</a>
                    <a href="form_professor.php" class="nav-item nav-link"><i class="fa fa-chalkboard-teacher me-2"></i>Professor</a>
        ...
        <div class="content">
            <!-- Navbar Start -->
            <nav class="navbar navbar-expand bg-white shadow navbar-light sticky-top px-4 py-0">
                            ...
                            <form action="salvar_aluno.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <!-- Campo para laço familiar opcional -->
